...
<tr class="odd">
<td><code id="appstream_create_fleet_:_FleetType">FleetType</code></td>
<td><p>The fleet type.</p>
<p><strong>ALWAYS_ON</strong></p>
<p>Provides users with instant-on access to their apps. You are charged
for all running instances in your fleet, even if no users are streaming
apps.</p>
<p><strong>ON_DEMAND</strong></p>
<p>Provide users with access to applications after they connect, which
...
<tr class="even">
<td><code
id="appstream_create_fleet_:_ComputeCapacity">ComputeCapacity</code></td>
<td><p>The desired capacity for the fleet. This is not allowed for
Elastic fleets. For Elastic fleets, specify MaxConcurrentSessions
instead.</p></td>
</tr>
<tr class="odd">
<td><code id="appstream_create_fleet_:_VpcConfig">VpcConfig</code></td>
...
<tr class="even">
<td><code
id="appstream_create_fleet_:_MaxUserDurationInSeconds">MaxUserDurationInSeconds</code></td>
