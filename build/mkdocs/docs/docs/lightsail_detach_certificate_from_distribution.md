...
<tbody>
<tr class="odd">
<td>lightsail_detach_certificate_from_distribution</td>
...
<tr class="odd">
<td><code
id="lightsail_detach_certificate_from_distribution_:_distributionName">distributionName</code></td>
<td><p>[required] The name of the distribution from which to detach the
certificate.</p>
