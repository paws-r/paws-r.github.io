...
<tbody>
<tr class="odd">
<td>sagemaker_describe_inference_recommendations_job</td>
...
<tr class="odd">
<td><code
id="sagemaker_describe_inference_recommendations_job_:_JobName">JobName</code></td>
<td><p>[required] The name of the job. The name must be unique within an
Amazon Web Services Region in the Amazon Web Services account.</p></td>
</tr>
</tbody>
</table>
