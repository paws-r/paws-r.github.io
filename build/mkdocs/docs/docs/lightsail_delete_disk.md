...
<tbody>
<tr class="odd">
<td><code id="lightsail_delete_disk_:_diskName">diskName</code></td>
<td><p>[required] The unique name of the disk you want to delete (e.g.,
<code>my-disk</code>).</p></td>
</tr>
<tr class="even">
<td><code
id="lightsail_delete_disk_:_forceDeleteAddOns">forceDeleteAddOns</code></td>
<td><p>A Boolean value to indicate whether to delete all add-ons for the
disk.</p></td>
</tr>
</tbody>
</table>
