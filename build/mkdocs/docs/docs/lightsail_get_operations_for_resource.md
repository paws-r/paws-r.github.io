...
<tbody>
<tr class="odd">
<td>lightsail_get_operations_for_resource</td>
...
<tr class="odd">
<td><code
id="lightsail_get_operations_for_resource_:_resourceName">resourceName</code></td>
<td><p>[required] The name of the resource for which you are requesting
information.</p></td>
</tr>
<tr class="even">
<td><code
id="lightsail_get_operations_for_resource_:_pageToken">pageToken</code></td>
<td><p>The token to advance to the next page of results from your
request.</p>
<p>To get a page token, perform an initial
<code>get_operations_for_resource</code> request. If your results are
