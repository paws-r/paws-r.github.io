...
### Usage
    ...
    sagemaker_update_space(DomainId, SpaceName, SpaceSettings)
...
<tbody>
<tr class="odd">
<td><code id="sagemaker_update_space_:_DomainId">DomainId</code></td>
<td><p>[required] The ID of the associated Domain.</p></td>
</tr>
<tr class="even">
<td><code id="sagemaker_update_space_:_SpaceName">SpaceName</code></td>
<td><p>[required] The name of the space.</p></td>
</tr>
<tr class="odd">
<td><code
id="sagemaker_update_space_:_SpaceSettings">SpaceSettings</code></td>
