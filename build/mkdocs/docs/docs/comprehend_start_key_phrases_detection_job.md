...
<tbody>
<tr class="odd">
<td>comprehend_start_key_phrases_detection_job</td>
...
<tr class="odd">
<td><code
id="comprehend_start_key_phrases_detection_job_:_InputDataConfig">InputDataConfig</code></td>
<td><p>[required] Specifies the format and location of the input data
for the job.</p></td>
</tr>
<tr class="even">
<td><code
id="comprehend_start_key_phrases_detection_job_:_OutputDataConfig">OutputDataConfig</code></td>
<td><p>[required] Specifies where to send the output files.</p></td>
</tr>
<tr class="odd">
<td><code
id="comprehend_start_key_phrases_detection_job_:_DataAccessRoleArn">DataAccessRoleArn</code></td>
...
<tr class="even">
<td><code
id="comprehend_start_key_phrases_detection_job_:_JobName">JobName</code></td>
<td><p>The identifier of the job.</p></td>
</tr>
<tr class="odd">
<td><code
id="comprehend_start_key_phrases_detection_job_:_LanguageCode">LanguageCode</code></td>
...
<tr class="even">
<td><code
id="comprehend_start_key_phrases_detection_job_:_ClientRequestToken">ClientRequestToken</code></td>
<td><p>A unique identifier for the request. If you don't set the client
request token, Amazon Comprehend generates one.</p></td>
</tr>
<tr class="odd">
<td><code
id="comprehend_start_key_phrases_detection_job_:_VolumeKmsKeyId">VolumeKmsKeyId</code></td>
...
<tr class="even">
<td><code
id="comprehend_start_key_phrases_detection_job_:_VpcConfig">VpcConfig</code></td>
<td><p>Configuration parameters for an optional private Virtual Private
Cloud (VPC) containing the resources you are using for your key phrases
...
<tr class="odd">
<td><code
id="comprehend_start_key_phrases_detection_job_:_Tags">Tags</code></td>
<td><p>Tags to associate with the key phrases detection job. A tag is a
