...
<tbody>
<tr class="odd">
<td>ec2_create_launch_template_version</td>
...
### Usage
    ...
    ec2_create_launch_template_version(DryRun, ClientToken,
      ...
      LaunchTemplateData, ResolveAlias)
...
<tr class="odd">
<td><code
id="ec2_create_launch_template_version_:_DryRun">DryRun</code></td>
...
<tr class="even">
<td><code
id="ec2_create_launch_template_version_:_ClientToken">ClientToken</code></td>
...
<tr class="odd">
<td><code
id="ec2_create_launch_template_version_:_LaunchTemplateId">LaunchTemplateId</code></td>
...
<tr class="even">
<td><code
id="ec2_create_launch_template_version_:_LaunchTemplateName">LaunchTemplateName</code></td>
...
<tr class="odd">
<td><code
id="ec2_create_launch_template_version_:_SourceVersion">SourceVersion</code></td>
<td><p>The version number of the launch template version on which to
...
in <code>LaunchTemplateData</code>. Snapshots applied to the block
device mapping are ignored when creating a new version unless they are
explicitly included.</p></td>
</tr>
<tr class="even">
<td><code
id="ec2_create_launch_template_version_:_VersionDescription">VersionDescription</code></td>
<td><p>A description for the version of the launch template.</p></td>
</tr>
<tr class="odd">
<td><code
id="ec2_create_launch_template_version_:_LaunchTemplateData">LaunchTemplateData</code></td>
<td><p>[required] The information for the launch template.</p></td>
</tr>
<tr class="even">
<td><code
id="ec2_create_launch_template_version_:_ResolveAlias">ResolveAlias</code></td>
...
response for <code>imageID</code>. For more information, see <a
