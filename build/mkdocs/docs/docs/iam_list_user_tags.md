...
<tbody>
<tr class="odd">
<td><code id="iam_list_user_tags_:_UserName">UserName</code></td>
<td><p>[required] The name of the IAM user whose tags you want to
see.</p>
...
<tr class="even">
<td><code id="iam_list_user_tags_:_Marker">Marker</code></td>
...
<tr class="odd">
<td><code id="iam_list_user_tags_:_MaxItems">MaxItems</code></td>
