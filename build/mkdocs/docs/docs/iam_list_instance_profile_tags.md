...
<tbody>
<tr class="odd">
<td>iam_list_instance_profile_tags</td>
...
<tr class="odd">
<td><code
id="iam_list_instance_profile_tags_:_InstanceProfileName">InstanceProfileName</code></td>
<td><p>[required] The name of the IAM instance profile whose tags you
want to see.</p>
...
<tr class="even">
<td><code
id="iam_list_instance_profile_tags_:_Marker">Marker</code></td>
...
<tr class="odd">
<td><code
id="iam_list_instance_profile_tags_:_MaxItems">MaxItems</code></td>
