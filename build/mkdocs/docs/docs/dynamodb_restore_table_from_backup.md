...
<tbody>
<tr class="odd">
<td>dynamodb_restore_table_from_backup</td>
...
You can call `restore_table_from_backup` at a maximum rate of 10 times
per second.
...
<tr class="odd">
<td><code
id="dynamodb_restore_table_from_backup_:_TargetTableName">TargetTableName</code></td>
<td><p>[required] The name of the new table to which the backup must be
restored.</p></td>
</tr>
<tr class="even">
<td><code
id="dynamodb_restore_table_from_backup_:_BackupArn">BackupArn</code></td>
<td><p>[required] The Amazon Resource Name (ARN) associated with the
backup.</p></td>
</tr>
<tr class="odd">
<td><code
id="dynamodb_restore_table_from_backup_:_BillingModeOverride">BillingModeOverride</code></td>
<td><p>The billing mode of the restored table.</p></td>
</tr>
<tr class="even">
<td><code
id="dynamodb_restore_table_from_backup_:_GlobalSecondaryIndexOverride">GlobalSecondaryIndexOverride</code></td>
...
<tr class="odd">
<td><code
id="dynamodb_restore_table_from_backup_:_LocalSecondaryIndexOverride">LocalSecondaryIndexOverride</code></td>
...
<tr class="even">
<td><code
id="dynamodb_restore_table_from_backup_:_ProvisionedThroughputOverride">ProvisionedThroughputOverride</code></td>
<td><p>Provisioned throughput settings for the restored table.</p></td>
</tr>
<tr class="odd">
<td><code
id="dynamodb_restore_table_from_backup_:_SSESpecificationOverride">SSESpecificationOverride</code></td>
