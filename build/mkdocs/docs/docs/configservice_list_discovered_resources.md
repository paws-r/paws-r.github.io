...
<tbody>
<tr class="odd">
<td>configservice_list_discovered_resources</td>
...
<tr class="odd">
<td><code
id="configservice_list_discovered_resources_:_resourceType">resourceType</code></td>
<td><p>[required] The type of resources that you want Config to list in
the response.</p></td>
</tr>
<tr class="even">
<td><code
id="configservice_list_discovered_resources_:_resourceIds">resourceIds</code></td>
<td><p>The IDs of only those resources that you want Config to list in
...
minimum of 1 resourceID and a maximum of 20 resourceIds.</p></td>
</tr>
<tr class="odd">
<td><code
id="configservice_list_discovered_resources_:_resourceName">resourceName</code></td>
<td><p>The custom name of only those resources that you want Config to
list in the response. If you do not specify this parameter, Config lists
all resources of the specified type that it has discovered.</p></td>
</tr>
<tr class="even">
<td><code
id="configservice_list_discovered_resources_:_limit">limit</code></td>
<td><p>The maximum number of resource identifiers returned on each page.
The default is 100. You cannot specify a number greater than 100. If you
specify 0, Config uses the default.</p></td>
</tr>
<tr class="odd">
<td><code
id="configservice_list_discovered_resources_:_includeDeletedResources">includeDeletedResources</code></td>
<td><p>Specifies whether Config includes deleted resources in the
results. By default, deleted resources are not included.</p></td>
</tr>
<tr class="even">
<td><code
id="configservice_list_discovered_resources_:_nextToken">nextToken</code></td>
