...
<tbody>
<tr class="odd">
<td>appmesh_delete_virtual_service</td>
...
<tr class="odd">
<td><code
id="appmesh_delete_virtual_service_:_meshName">meshName</code></td>
<td><p>[required] The name of the service mesh to delete the virtual
service in.</p></td>
</tr>
<tr class="even">
<td><code
id="appmesh_delete_virtual_service_:_meshOwner">meshOwner</code></td>
...
<tr class="odd">
<td><code
id="appmesh_delete_virtual_service_:_virtualServiceName">virtualServiceName</code></td>
<td><p>[required] The name of the virtual service to delete.</p></td>
</tr>
</tbody>
</table>
