...
<tbody>
<tr class="odd">
<td>iam_list_attached_role_policies</td>
...
inline policies for a role, use `list_role_policies`. For information
...
<tr class="odd">
<td><code
id="iam_list_attached_role_policies_:_RoleName">RoleName</code></td>
<td><p>[required] The name (friendly name, not ARN) of the role to list
...
<tr class="even">
<td><code
id="iam_list_attached_role_policies_:_PathPrefix">PathPrefix</code></td>
...
<tr class="odd">
<td><code
id="iam_list_attached_role_policies_:_Marker">Marker</code></td>
...
<tr class="even">
<td><code
id="iam_list_attached_role_policies_:_MaxItems">MaxItems</code></td>
