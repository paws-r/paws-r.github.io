...
<tbody>
<tr class="odd">
<td>lightsail_delete_certificate</td>
...
deleted. Use the `detach_certificate_from_distribution` action to detach
...
<tr class="odd">
<td><code
id="lightsail_delete_certificate_:_certificateName">certificateName</code></td>
<td><p>[required] The name of the certificate to delete.</p>
<p>Use the <code>get_certificates</code> action to get a list of
certificate names that you can specify.</p></td>
</tr>
</tbody>
</table>
