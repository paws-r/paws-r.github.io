...
<tr class="odd">
<td><code
id="lightsail_create_domain_:_domainName">domainName</code></td>
<td><p>[required] The domain name to manage (e.g.,
<code>example.com</code>).</p></td>
</tr>
<tr class="even">
<td><code id="lightsail_create_domain_:_tags">tags</code></td>
