...
<tbody>
<tr class="odd">
<td><code id="iam_list_policy_tags_:_PolicyArn">PolicyArn</code></td>
<td><p>[required] The ARN of the IAM customer managed policy whose tags
you want to see.</p>
...
<tr class="even">
<td><code id="iam_list_policy_tags_:_Marker">Marker</code></td>
...
<tr class="odd">
<td><code id="iam_list_policy_tags_:_MaxItems">MaxItems</code></td>
