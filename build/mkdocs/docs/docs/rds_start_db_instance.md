...
PostgreSQL. For Aurora DB clusters, use `start_db_cluster` instead.
...
<tr class="odd">
<td><code
id="rds_start_db_instance_:_DBInstanceIdentifier">DBInstanceIdentifier</code></td>
