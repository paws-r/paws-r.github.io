...
<tbody>
<tr class="odd">
<td>lightsail_put_instance_public_ports</td>
...
you want to open in your `put_instance_public_ports`request. Or use the
`open_instance_public_ports` action to open ports without closing
currently open ports.

The `put_instance_public_ports` action supports tag-based access control
...
<tr class="odd">
<td><code
id="lightsail_put_instance_public_ports_:_portInfos">portInfos</code></td>
<td><p>[required] An array of objects to describe the ports to open for
the specified instance.</p></td>
</tr>
<tr class="even">
<td><code
id="lightsail_put_instance_public_ports_:_instanceName">instanceName</code></td>
