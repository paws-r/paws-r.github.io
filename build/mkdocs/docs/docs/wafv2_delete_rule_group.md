...
<tbody>
<tr class="odd">
<td><code id="wafv2_delete_rule_group_:_Name">Name</code></td>
<td><p>[required] The name of the rule group. You cannot change the name
of a rule group after you create it.</p></td>
</tr>
<tr class="even">
<td><code id="wafv2_delete_rule_group_:_Scope">Scope</code></td>
...
<tr class="odd">
<td><code id="wafv2_delete_rule_group_:_Id">Id</code></td>
...
<tr class="even">
<td><code id="wafv2_delete_rule_group_:_LockToken">LockToken</code></td>
