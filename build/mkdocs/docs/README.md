...
files, and IAM roles. See [articles/credentials.md](articles/credentials.md) for more
info.
...
![](img/code_completion.gif)

There are also examples for [EC2](examples/ec2.md), [S3](examples/s3.md),
[SQS](examples/sqs.md), [SNS](examples/sns.md),
[DynamoDB](examples/dynamodb.md), [Lambda](examples/lambda.md),
[Batch](examples/batch.md), and [Comprehend](examples/comprehend.md).
...
Logo by [Hsinyi Chen](https://linktr.ee/starfolio).

[Home page design](https://paws-r.github.io) and [cheat sheet](articles/cheat_sheet.pdf) by Mara Ursu.
